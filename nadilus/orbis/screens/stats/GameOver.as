package nadilus.orbis.screens.stats
{
	...
	public class GameOver extends MovieClip
	{
		...
		public function GameOver(gameScreen:GameScreen, player, destBlocks:uint, blocksScore:uint, bonusScore:uint, totalBounces:uint)
		{
			trace("GameOver: GameOver(): Called");
			...
			playNext.addEventListener(MouseEvent.CLICK, retryLevel, false, 0, true);
		}
		
		private function retryLevel(event:MouseEvent) {
			trace("GameStats: nextLevel(): Called");
			playNext.removeEventListener(MouseEvent.CLICK, retryLevel);
			_gScreen.retryLevel();
		}
